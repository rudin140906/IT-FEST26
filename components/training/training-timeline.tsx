  ...
  return (
    <section className="pb-12 relative">
      ...
      <div className="hidden md:block relative px-4">
        ...
        <div className="flex justify-center flex-wrap gap-x-8 gap-y-10 relative z-10">
          {trainingTimeline.map((item, i) => (
            <div key={item.step} className="flex flex-col items-center text-center w-44 group">
