...
export async function GET() {
  try {
    ...
    // Add image_url column if missing in timeline
    try {
    ...
    if (eventCount === 0) {
      await connection.query(`
        INSERT INTO events (id, title, category, category_label, description, icon_type, badge_color, gform_url, guidebook_url) VALUES
        ('ml', 'Mobile Legends', 'kompetisi', 'KOMPETISI', 'Buktikan skill dan kerja sama timmu di arena Mobile Legends, raih kemenangan demi kemenangan.', 'gamepad', 'cyan', 'https://forms.google.com/', ''),
        ('ff', 'Free Fire', 'kompetisi', 'KOMPETISI', 'Turun ke medan pertempuran Free Fire, jadi yang terakhir bertahan dan raih Booyah!', 'flame', 'pink', 'https://forms.google.com/', ''),
        ('vibe-coding-comp', 'Vibe Coding Competition', 'kompetisi', 'KOMPETISI', 'Bangun aplikasi atau produk digital secepat mungkin menggunakan bantuan AI, untuk menciptakan kreativitas.', 'code', 'yellow', 'https://forms.google.com/', ''),
        ('ctf-comp', 'Capture The Flag Competition', 'kompetisi', 'KOMPETISI', 'Uji kemampuan hacking dan keamanan sibermu dengan memecahkan berbagai tantangan CTF dari level pemula hingga expert.', 'shield', 'cyan', 'https://forms.google.com/', ''),
        ('photography-comp', 'Photography Competition', 'kompetisi', 'KOMPETISI', 'Tunjukkan sudut pandang kreatifmu lewat lensa kamera dan abadikan momen terbaik dalam kompetisi fotografi ini.', 'camera', 'pink', 'https://forms.google.com/', ''),
        ('vibe-coding-training', 'Vibe Coding', 'pelatihan', 'PELATIHAN', 'Belajar membangun aplikasi dan produk digital secara cepat dengan bantuan AI, dari ide sampai jadi produk nyata.', 'code', 'yellow', 'https://forms.google.com/', ''),
        ('cyber-security-training', 'Cyber Security', 'pelatihan', 'PELATIHAN', 'Pelajari dasar-dasar keamanan siber, mulai dari deteksi celah keamanan hingga teknik perlindungan sistem.', 'shield', 'cyan', 'https://forms.google.com/', ''),
        ('seminar-itfest', 'Seminar IT-Festival 2026', 'seminar', 'SEMINAR', 'Ikuti seminar kami dan dapatkan wawasan berharga langsung dari para ahli di bidang teknologi.', 'mic', 'pink', 'https://forms.google.com/', '');
      `);
      eventsSeeded = true;
    }
    ...
    return NextResponse.json({
      success: true,
      message: "Database `it_festival` dan semua tabel (`sponsors`, `media_partners`, `timeline`, `events`) berhasil disiapkan!",
